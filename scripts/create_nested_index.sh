...
curl -X PUT 'localhost:9200/collection_analysis_nested?pretty' -H 'Content-Type: application/json' -d '@../mappings/nested_mapping.json'
...
# Populate the index
../bin/populate_nested_index.rb ../raw_data/TF-SK-Output.json collection_analysis_nested SEND